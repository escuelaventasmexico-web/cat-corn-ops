...
export default function CommercialDeliveryUnitsPanel({ partnerId, sourceType, onReleased, refreshKey }: Props) {
  ...
  const visible = useMemo(() => units.filter(unit => !query || [unit.scan_code, unit.product_name, unit.product_variant, unit.product_size]
